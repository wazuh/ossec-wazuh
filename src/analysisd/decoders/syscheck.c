...
void sdb_init(_sdb *localsdb, OSDecoderInfo *fim_decoder) {
    ...
    fim_decoder->fields[FIM_FILE] = "path";
    fim_decoder->fields[FIM_HARD_LINKS] = "hard_links";
    fim_decoder->fields[FIM_MODE] = "mode";
    fim_decoder->fields[FIM_SIZE] = "size_after";
    fim_decoder->fields[FIM_SIZE_BEFORE] = "size_before";
    fim_decoder->fields[FIM_PERM] = "perm_after";
    fim_decoder->fields[FIM_PERM_BEFORE] = "perm_before";
    fim_decoder->fields[FIM_UID] = "uid_after";
    fim_decoder->fields[FIM_UID_BEFORE] = "uid_before";
    fim_decoder->fields[FIM_GID] = "gid_after";
    fim_decoder->fields[FIM_GID_BEFORE] = "gid_before";
    fim_decoder->fields[FIM_MD5] = "md5_after";
    fim_decoder->fields[FIM_MD5_BEFORE] = "md5_before";
    fim_decoder->fields[FIM_SHA1] = "sha1_after";
    fim_decoder->fields[FIM_SHA1_BEFORE] = "sha1_before";
    fim_decoder->fields[FIM_UNAME] = "uname_after";
    fim_decoder->fields[FIM_UNAME_BEFORE] = "uname_before";
    fim_decoder->fields[FIM_GNAME] = "gname_after";
    fim_decoder->fields[FIM_GNAME_BEFORE] = "gname_before";
    fim_decoder->fields[FIM_MTIME] = "mtime_after";
    fim_decoder->fields[FIM_MTIME_BEFORE] = "mtime_before";
    fim_decoder->fields[FIM_INODE] = "inode_after";
    fim_decoder->fields[FIM_INODE_BEFORE] = "inode_before";
    fim_decoder->fields[FIM_SHA256] = "sha256_after";
    fim_decoder->fields[FIM_SHA256_BEFORE] = "sha256_before";
    fim_decoder->fields[FIM_DIFF] = "diff";
    fim_decoder->fields[FIM_ATTRS] = "attrs_after";
    fim_decoder->fields[FIM_ATTRS_BEFORE] = "win_attributes_before";
    fim_decoder->fields[FIM_CHFIELDS] = "changed_attributes";
    fim_decoder->fields[FIM_USER_ID] = "audit.user.id";
    fim_decoder->fields[FIM_USER_NAME] = "audit.user.name";
    fim_decoder->fields[FIM_GROUP_ID] = "audit.group.id";
    fim_decoder->fields[FIM_GROUP_NAME] = "audit.group.name";
    fim_decoder->fields[FIM_PROC_NAME] = "audit.process.name";
    fim_decoder->fields[FIM_PROC_PNAME] = "audit.process.parent_name";
    fim_decoder->fields[FIM_AUDIT_CWD] = "audit.process.cwd";
    fim_decoder->fields[FIM_AUDIT_PCWD] = "audit.process.parent_cwd";
    fim_decoder->fields[FIM_AUDIT_ID] = "audit.login_user.id";
    fim_decoder->fields[FIM_AUDIT_NAME] = "audit.login_user.name";
    fim_decoder->fields[FIM_EFFECTIVE_UID] = "audit.effective_user.id";
    fim_decoder->fields[FIM_EFFECTIVE_NAME] = "audit.effective_user.name";
    fim_decoder->fields[FIM_PPID] = "audit.process.ppid";
    fim_decoder->fields[FIM_PROC_ID] = "audit.process.id";
    fim_decoder->fields[FIM_TAG] = "tags";
    ...
    fim_decoder->fields[FIM_EVENT_TYPE] = "event";
}
